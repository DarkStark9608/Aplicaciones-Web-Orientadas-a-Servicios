	...
	def GET(self, zodiaco):
		try:
			...
			if dia >= 22 and mes == 12 or mes == 1 and dia <= 19:
				...
				datos[
				    "Descripcion"] = "La política, la tierra, los lugares elevados, las montañas, las cimas, los lugares aislados e inaccesibles, las luchas, los obstáculos e impedimentos, la mala suerte, los reveses de fortuna, las carreras brillantes, la decadencia, el tiempo, la noche, los viejos, las deformidades, el invierno, el frío, las minas, el deber cívico y las ambiciones profesionales."
				datos["Elemento"] = "Tierra"
				datos["Numero"] = "1, 4, 8, 10, 13, 17, 19, 22, 26"
				datos["Color"] = "Gris Oscuro, Marrón, Negro y Castaño"
				datos[
				    "Del_dia"] = "Hoy será un buen día para la firma de contratos y para las asociaciones, también lo será para las actividades relacionadas con la filosofía y la educación. Sin embargo, tienes que precaverte de pensamientos utópicos, ya que esto podría hacer que tu concentración no sea óptima y que te disperses."
				datos[
				    "Del_dia"] = "Hoy podrías sentir que es necesario hacer cambios de tipo ambiental, tanto en el trabajo como en casa. Alguna situación está por explotar y podría haber tendencia a rupturas. Podrías sentirte físicamente mal, será mejor que cuides de tu salud, sobre todo tus huesos y tu sistema respiratorio; si fumas, este será el momento de dejarlo."
				datos[
				    "Del_dia"] = "Te sentirás feliz hoy. Será un día de reencuentros amorosos y de toma de decisiones no solamente en lo afectivo, sino también en lo profesional. Selecciona lo que creas que es mejor; te conviene seguir a tu intuición. En el terreno laboral, si tu profesión está relacionada con las finanzas, tendrás un buen día de trabajo. !Felicidades!"
				datos[
				    "Del_dia"] = "Será un día para pasarlo con la familia, la pareja y los amigos. Capricornio, si puedes, sal de viaje, te sentará muy bien; olvidarás la rutina diaria y recobrarás fuerzas. En este sentido, el mejor lugar para ir será un entorno natural y plácido. También podrías salir a comer fuera con tu familia o con las personas a quienes quieres."
				datos[
				    "Del_dia"] = "Hoy dedicarás el día al amor y a la amistad; la intimidad será lo que más te apetezca. Es necesario que expreses tus emociones y que comuniques lo que piensas a tu pareja, porque tal vez te esté notando algo distante y preocupado-a por los problemas cotidianos laborales. Para lograr equilibrio, hay que darle al César lo que es del César... y a tu pareja lo que le corresponde."
				...
				datos[
				    "Del_dia"] = "Hoy será un día de reencuentros con las personas a quienes amas o a quienes amaste. Puede que tengas que tomar decisiones en este sentido; una persona influyente podría acercarse a ti: utiliza tu intuición y decide lo que creas conveniente. Piscis, si ya tienes pareja, podrías encontrarte en una disyuntiva nada agradable."
				datos[
				    "Del_dia"] = "Tu trabajo y tu servicio serán valorados en este día, recibirás recompensas tanto en el terreno emocional como en el económico. Hoy podría ser un día de éxito y de múltiples realizaciones, siempre y cuando no te aísles. Recuerda que la amistad es algo muy importante que todos necesitamos, y tú más que nadie."
				datos[
				    "Del_dia"] = "Te refugias en el pasado con demasiada frecuencia cuando sientes que el ambiente no es propicio. Hoy tratarás de aislarte, pero sería muchísimo mejor que salieses al mundo y vieras lo hermoso que es. Tienes muchas cosas que realizar; los últimos días han sido difíciles: ubícate y trata de empezar un nuevo proyecto, comprobarás el resultado."
				datos[
				    "Del_dia"] = "Hoy te sentirás renovado-a y feliz; lo que más te convendrá será salir de la ciudad en companía de tu familia, pareja o amistades. Elige un lugar totalmente nuevo, pero en el que te sientas en armonía con la naturaleza. Si no puedes salir fuera, elige un buen restaurante y goza de una suculenta comida con un vinito... !pero solamente uno!"
				datos[
				    "Del_dia"] = "El amor te sonreirá hoy, tal vez se trate de un reencuentro amoroso. Puede incluso que tengas que elegir entre dos opciones sentimentales: selecciona siguiendo a tu intuición, pero trata de no idealizar demasiado a esa persona o luego te desilusionarás drásticamente. Piscis, hoy todo lo relacionado con la belleza te aportará equilibrio."
				result = json.dumps(datos)
				return result
				...
				datos["Color"] = "Rojo"
				datos[
				    "Del_dia"] = "Hoy será un día de posibles logros, Aries, tanto en el terreno profesional como en el sentimental. Una persona con experiencia podría ofrecerte su apoyo; además, las relaciones con las personas que representen cierta autoridad sobre ti, como los maestros, estarán también de tu parte. !Felicidades!"
				datos[
				    "Del_dia"] = "Tendrás un día muy fecundo. Los proyectos que hoy se inicien tendrán unas magníficas perspectivas de futuro; además, podrías hacer nuevos descubrimientos. Te sentirás fuerte y vital, energético-a, y también muy sensual. Podrías desarrollar proyectos interesantes que posiblemente deriven de tus relaciones con personas de fuera de tu entorno.."
				datos[
				    "Del_dia"] = "Este día deberías dedicárselo al amor y a la amistad: sé generoso-a y verás brillar el sol en tu vida. Será un día de realizaciones agradables en el amor si expresas tus emociones. Después de tus labores cotidianas, invita a tu pareja a algún lugar romántico y agradable. Ten cuidado en tus relaciones con las personas ancianas y con la autoridad."
				datos[
				    "Del_dia"] = "Pasarás un día en el que tenderás a la riqueza en general, tanto en lo material como en lo sentimental. Sin embargo, es posible que tengas que tomar decisiones; podrían producirse reencuentros amorosos. Aries, es un sábado para buscar el equilibrio a través de la pareja; te notarás muy sensual."
				datos[
				    "Del_dia"] = "Una persona desconocida para ti hasta ahora, pero influyente se acercará a ti: no tomes decisiones bruscas, te podrían conducir al desastre. Piensa en lo que ahora deseas cambiar en tu vida, la energía para hacer ese tipo de transformación será la apropiada. Tu energía sexual subirá y te sentirás con poder."
				result = json.dumps(datos)
				return result
				...
				datos[
				    "Del_dia"] = "Te espera un domingo maravilloso; te sentirás mucho mejor. No te aísles, Géminis, sal y diviértete con tus amigos-as o con la familia; será un día para expresar tus emociones positivamente. Hoy podrías conocer a una persona de fuera que puede convertirse en alguien significativo en tu vida futura."
				result = json.dumps(datos)
				return result
				...
				datos[
				    "Del_dia"] = "Será un día importante para el amor y la amistad: trata de actuar de una forma equilibrada y de no ser intransigente. Es momento de poner en orden las cosas de tu vida. Virgo, si tienes dudas respecto a algo, háblalo con alguien de tu confianza, es posible que su punto de vista te proporcione un nuevo prisma."
				datos[
				    "Del_dia"] = "Hoy será un día donde tendrás que moverte con rectitud, ser prudente y permanecer alerta ante lo que acontezca. El aprendizaje estará en la discreción, será un muy buen día para las actividades que se dediquen al bienestar físico y espiritual; el servicio hacia la sociedad será recompensado por diferentes personas, pues te ganarás su confianza."
				datos[
				    "Del_dia"] = "Hoy te sentirás mucho mejor y recibirás gratificaciones o regalos, también la ayuda de alguien. Se materializarán algunos proyectos, además, te encontrarás en buena forma intelectual; sin embargo, es necesario que dejes que tus sentimientos ocupen su lugar y que tu corazón hable... A veces, te olvidas de esta faceta de la vida."
				datos[
				    "Del_dia"] = "Disfrutarás de un día maravilloso que deberías dedicar a los tuyos. Sigue a tus instintos y se desarrollará tu creatividad. Habrá abundancia en el terreno material: compártela con quienes más quieres. Una buena opción será salir a comer fuera con tus amigos-as o pareja y también ir a conciertos y otras actividades culturales. !Felicidades!"
				datos[
				    "Del_dia"] = "Virgo, no discutas, y menos con tu familia, no te traerá nada positivo. Mejor utiliza la energía de una forma positiva, expresa tus sentimientos, escribe aunque simplemente sea para ti mismo-a. Tus sueńos te darán respuestas. Sal al cine con los amigos a ver una película que os interese o haz cualquier cosa que evite que te aísles."
				result = json.dumps(datos)
				return result
				...
				datos[
				    "Del_dia"] = "Te espera un día difícil en el ámbito emocional y en las relaciones, sobre todo afectivas; tendrás que actuar con templanza. Tal vez tengas dificultades para realizar contactos, esto se deberá a una comunicación deficiente o confusa. En el trabajo sería recomendable que te concentrases y que solucionases ya lo que tengas pendiente."
				datos[
				    "Del_dia"] = "Escorpio, por la mańana hoy habrá aún cierta tensión: no discutas con quienes más quieres, mejor sigue a tu intuición, te ayudará. En el terreno del trabajo no será recomendable que cierres contratos; sin embargo, hoy podrías conseguir el prestigio y el reconocimiento a tu trabajo."
				datos[
				    "Del_dia"] = "Hoy será un día para pasarlo bien con los amigos y con tu pareja, si la tienes, pues tu sensualidad estará a flor de piel. Además, si deseas procrear será el día perfecto, pues habrá fertilidad para sembrar cualquier cosa, desde una planta, un bebe, hasta un proyecto. Escorpio, cualquier cosa que inicies tendrá el éxito asegurado."
				datos[
				    "Del_dia"] = "Si tienes oportunidad, sal a hacer un pequeńo viaje, te hará muy bien; puede ser familiar, con la pareja o con tus amistades. El campo o un lugar en el que la energía de la armonía vibre sería lo más adecuado. Aprovecha este día tanto en tus emociones como en la sensualidad, porque estarán vibrando armoniosamente y será el momento de darles expresión. !Felicidades!"
				datos[
				    "Del_dia"] = "Te sentirás muy vital y tu capacidad de organizar estará en un alto nivel para iniciar cualquier proyecto que te propongas. Escorpio, este domingo tus emociones serán intensas y tu intuición profunda. También será un buen día para pasarlo con la familia, una buena comida fuera de casa será la mejor alternativa."
				result = json.dumps(datos)
				return result
